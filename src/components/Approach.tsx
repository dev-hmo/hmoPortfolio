    ...
    return (
        <section className="w-full py-20">
            <h1 className="heading text-center text-3xl md:text-5xl font-bold mb-16 text-neutral-200">
                My <span className="text-cyan-500">approach</span>
            </h1>
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 max-w-7xl mx-auto px-8">
                <Card
...
const AceternityIcon = ({ order }: { order: string }) => {
    return (
        ...
        justify-center rounded-full bg-slate-950 px-5 py-2 text-purple backdrop-blur-3xl font-bold text-2xl text-cyan-400"
                >
                    {order}
                </span>
            </button>
